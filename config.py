...
OWNER_ID = int(getenv("OWNER_ID", "5480218118"))
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://humansweet:dewimur123@cluster0.vuehb51.mongodb.net/?retryWrites=true&w=majority")
